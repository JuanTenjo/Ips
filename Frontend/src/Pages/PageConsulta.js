...
import FormConsuta from '../Components/RegistroConsulta/FormConsulta';
import TableConsulta from '../Components/RegistroConsulta/TableConsulta';
...
const PageConsulta = () => {
  ...
  const traerUsuarios = async () => {
    setLoading(true);       
    const data = await helpHttpAxios().get(`${API.URI}/queries/`);                                                                                                                
